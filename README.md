...
those filter rules will apply blocks to the domains instead.
...
GNU GENERAL PUBLIC LICENSE - see [LICENSE](https://github.com/picklesnicholls/adguard-ms-allowlist/blob/main/LICENSE) file. Provided as-is, with no guarantee of completeness.
