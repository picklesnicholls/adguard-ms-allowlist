...
that prevents filtering from breaking Microsoft business services — Teams, Outlook,
Azure, Azure DevOps, OneDrive, SharePoint, Intune, Microsoft Authenticator and friends.
